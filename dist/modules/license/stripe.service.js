...
export class StripeService {
    ...
    constructor(stripeSecretKey, webhookSecret, licenseService) {
        ...
        if (!this.stripeSecretKey) {
            console.warn('Stripe secret key not configured. License features will be disabled.');
        }
    }
    /**
    ...
    async createCheckoutSession(params) {
        ...
        const priceId = params.tier === 'team' ? this.priceIds.team_monthly : undefined;
    ...
    async handleSubscriptionUpdated(event) {
        ...
        const license = this.licenseService.getLicenseByStripeSubscription(subscription.id);
        if (!license) {
        ...
        console.log(`License ${license.licenseKey} status updated to ${status}`);
        return { handled: true };
    }
    /**
